...
#define INITIAL_CONNECTION_TIMEOUT            (240*1000*1000/CFG_TS_TICK_VAL) /**< 240s */
...
static const char local_name[] = { AD_TYPE_COMPLETE_LOCAL_NAME, 'S', 'M', 'T','C','_','T','K','R','_','O', 'T', 'A' };
...
static void Connection_board_reset( void );
...
void APP_BLE_Init( void )
{
   ...
   */
  HW_TS_Create(CFG_TIM_PROC_ID_ISR, &Connection_mgr_timer_Id, hw_ts_SingleShot, Connection_board_reset);
    ...
    case EVT_LE_META_EVENT:
      ...
      switch (meta_evt->subevent)
      {
        case EVT_LE_CONN_COMPLETE:
            ...
            HW_TS_Start(Connection_mgr_timer_Id, INITIAL_CONNECTION_TIMEOUT);
...
static void Delete_Sectors( void )
{
  ...
  first_secure_sector_idx = (READ_BIT(FLASH->SFR, FLASH_SFR_SFSA) >> FLASH_SFR_SFSA_Pos) - 1 ; // - 1 because of sector 202 which contains tracker context
